...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002454842046 -1002165297790 -1002075429339 -1002618032610 -1002888854366').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002244548836') # give your force subscribe channel id here else leave it blank
...
#Auto forward info
FROM_DB = [int(fdb) for fdb in environ.get('FROM_DB', '0').split() if re.match(r'^-?\d+$', fdb)]
